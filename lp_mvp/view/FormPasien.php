...
class FormPasien implements KontrakViewForm
{
  ...
  function tampil()
  {
    ...
    $data .= '<form method="post" action="add.php">
      ...
      <h2 style="text-align: center; margin-bottom: 30px; background-color: black; color: #fff; padding: 10px;">Add Data</h2>
      <form method="post" action="add.php">
          ...
          <div class="form-group">
              <label for="lahir">Tanggal Lahir</label>
              <input type="date" class="form-control" name="lahir" id="tgl_lahir" required>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
              ...
              <input type="tel" class="form-control" name="telp" id="telp" placeholder="Masukkan Telepon" required>
          </div>
  ...
  function tampil2($i)
  {
    ...
    $data = '<div class="container">
    <h2 style="text-align: center; margin-bottom: 30px; background-color: black; color: #fff; padding: 10px;">Update Data</h2>
    <form method="post" action="add.php?id=' . $this->prosespasien->getId($i) . '">
        ...
        <div class="form-group">
            <label for="lahir">Tanggal Lahir</label>
            <input type="date" class="form-control" name = "lahir" id="lahir" placeholder="Masukkan lahir" value = "' . $this->prosespasien->getTl($i) . '" required>
